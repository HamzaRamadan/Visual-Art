...
const News = () => {
  ...
  const text = {
    date: isRTL ? `يسعدنا الإعلان عن مشاركة مصنعنا في معرض هيلث إكسبو – بغداد، والذي سيُقام من 18 إلى 21 أيلول. سنعرض خلاله جودة خدماتنا وإمكاناتنا المتقدمة في مجال الطباعة.
` : `We are pleased to announce our participation in Health Expo – Baghdad, taking place from September 18 to September 21. During the event, we will showcase the quality of our services and our advanced printing capabilities.`,
    title: isRTL ? 'معرض الصحة العراق 2025' : 'Health Expo Iraq 2025',
  ...
  <div className="video-wrapper">
    <iframe
      src="https://www.youtube.com/embed/KgYJeMz8ZdQ"
